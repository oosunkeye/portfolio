    ...
    <StyledHero>
      <Container>
        <Row className="align-items-center text-center">
          <Col>
            <h1 style={{fontSize: 45, color: "beige", }}><span style={{background: "black", paddingRight: 5, paddingLeft: 5}}>{name}</span></h1>
            <h4 style={{color: "beige"}}>I am a Full Stack Developer</h4>
